...
const WALLPAPER = "bg-gradient-to-br from-sky-500 via-indigo-200 to-pink-200";
...
export default function EscapeRoomDesktop() {
  ...
  const correctPassword = "Nugget2016"; // change to your puzzle password
        ...
        <div className="absolute inset-0 flex items-center justify-center px-4">
          <div className="bg-white/85 backdrop-blur-xl border border-white/60 rounded-3xl p-7 w-[420px] sm:w-[480px] shadow-2xl">
            ...
            <div className="flex flex-col items-center mb-4">
              ...
              />
              <div className="text-2xl font-bold text-gray-800 mt-2">Daniel Okafor</div>
